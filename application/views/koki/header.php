                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="koki/profil"><i class="fas fa-user mr-2"></i>Profil</a>
                                <a class="dropdown-item" href="koki/password"><i class="fas fa-key mr-2"></i>Password</a>
                                <a class="dropdown-item" href="koki/logout"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">Selamat Datang di Aplikasi Food Restaurant - Koki</h2>
                                </div>
                            </div>
                        </div>
                    <?php }else { ?>
